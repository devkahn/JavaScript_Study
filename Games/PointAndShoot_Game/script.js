...
class Raven {
    constructor() {
        this.spritedWidth = 271;
        this.spritedHeight = 194;
        this.sizeModifier = Math.random() *  0.6 + 0.4;
        this.width = this.spritedWidth / this.sizeModifier;
        this.height = this.spritedHeight / this.sizeModifier;
        this.x = canvas.width;
    ...
    draw() {
        ...
        ctx.drawImage(this.image, this.frame * this.spritedWidth, 0, this.spritedWidth, this.spritedHeight, this.x, this.y, this.width, this.height);
    }
}
...
class Explosion {
    constructor(x, y, size){
        ...
        this.frameIntervale = 200;
        this.markedForDeletion = false;
    }
    update(deltaTime){
        if(this.frame === 0) this.sound.play();
        this.timeSinceLastFrame += deltaTime;
        if(this.timeSinceLastFrame > this.frameIntervale) {
            this.frame ++;
            this.timeSinceLastFrame = 0;
