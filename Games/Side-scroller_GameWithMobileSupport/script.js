window.addEventListener('load', function(){
    ...
    class InputHandler {
        constructor() {
            ...
            window.addEventListener('touchmove', e => {
                ...
                if(swipeDistance < - this.touchTeshold && this.keys.indexOf('swipe up') === -1) this.keys.push('swipe up');
                else if(swipeDistance > this.touchTeshold && this.keys.indexOf('swipe down') === -1) {
    ...
    const background = new Background(canvas.width, this.height);
